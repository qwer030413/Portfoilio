...
function Experiences(props:any) {
    let timeLine = [
        ...
        },
        {
            ...
            location : "(Remote)",
            description1: "• Annotated and labeled 100+ datasets, ensuring high-quality training data to improve AI model accuracy",
            description2: "• Reviewed, analyzed, and debugged AI-generated code snippets, identifying logical errors and providing corrective feedback to refine AI-driven development tools",
            icon: <MdWork />
        },
        {
            id : 3,
            title: "Software Developer @ CSES",
            Used: "React Native | Node.js | PostgreSQL | AWS",
            date : "September 2024 - Present",
            location : "University of California, San Diego",
            description1: "• Integrated Node.js APIs to handle transactions and data processing, ensuring seamless backend communication",
            description2: "• Followed CI/CD Pipeline,  utilizing GitHub Actions for automated testing and deployment",
            icon: <MdWork />
        },
        {
            id : 4,
            ...
            description1: "• Designed and developed multiple reusable React Native components for a full-stack social media application, enhancing UI consistency and user engagement",
            description2: "• Integrated over 50+ Django REST APIs, ensuring low-latency data retrieval and seamless client-server communication",
            icon: <MdWork />
        },
        {
            id : 5,
        ...
        },
        {
            ...
            description1: "• Developed a basic recommendation system using Pandas and Jupyter Notebook, applying data analysis techniques to personalize user suggestions",
